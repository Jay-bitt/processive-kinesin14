...
N1 = 1500;
dt = 1e-6; T = 2e7;
dn = 5; Np0 = [14 20:10:100];
N0 = 125; nk = length(Np0); num = 0;
nni = 3; vx = zeros(nk,nni); v1 = vx; v2 = vx; v3 = vx; v4 = vx; v21 = vx; v22 = vx; v31 = vx; v32 = vx; v5 = vx; vxx = vx;
...
for ni = 1:nni
    ...
    for Np = Np0
        ...
        for i = 1:T
            ...
            [M3,m2,h2,state,lengthx,x,x1,x2,x3,x4,x5,x21,x22,x31,x32] = testM(M3,m2,h2,state,N1,N,dn,lengthx,x,x1,x2,x3,x4,x5,x21,x22,x31,x32,Np);
            if mod(i,1e5) == 0
